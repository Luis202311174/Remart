...
import { useRouter } from "next/navigation"; // ✅ new Next.js navigation hook
import { X } from "lucide-react";
import Header from "@/components/Header";
import ItemGrid from "@/components/ItemGrid";
import { fetchProductById, fetchSimilarProducts } from "@/lib/productFetcher";
import { createClient } from "@/utils/supabase/client"; // ✅ new Supabase helper
...
export default function ProductPage() {
  ...
  const supabase = createClient(); // ✅ unified Supabase client
    ...
    try {
      ...
      const res = await fetch("/api/cart/add", {
        ...
        body: JSON.stringify({
          ...
          quantity,
          buyerId: user.id, // ✅ associate with logged-in user
        }),
      });
