...
import { fetchAllProducts } from "@/lib/productFetcher"; // ✅ Use your cleaned fetcher

export async function getServerSideProps() {
  try {
    // ✅ Use the reusable fetcher instead of raw supabase call
    const items = await fetchAllProducts(50);
    return { props: { items } };
  } catch (error) {
  ...
  return (
    <main className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <div className="max-w-[1200px] mx-auto p-4">
        ...
        {/* ✅ Filter always works even if items = [] */}
